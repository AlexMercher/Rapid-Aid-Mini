...
PRE_IMPACT_WINDOW_END_SEC = 0.5
IMPACT_WINDOW_HALF_SEC = 0.5
IMPACT_FALLBACK_HALF_SEC = 2.5
GT_PRE_BUFFER_SEC = 0.5
POST_IMPACT_WINDOW_START_SEC = 0.5
POST_IMPACT_WINDOW_END_SEC = 2.5

# Minimum spacing between selected event-state frames
MIN_STATE_SEP_SEC = 0.6
MIN_STATE_SEP_FRAMES = 3

# ============================================================
# SEMANTIC NARRATION (BAKLLAVA)
# ============================================================
BAKLLAVA_TIMEOUT_SEC = 120
BAKLLAVA_SHORT_SIDE_PX = 512
